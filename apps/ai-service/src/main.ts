...
async function bootstrap() {
  ...
  switch (cfg.llmProvider) {
    ...
    case 'anthropic':
      ...
      app.log.warn({ cfg: { llmProvider: cfg.llmProvider } },
        'Real LLM provider not wired yet; using stub. See apps/ai-service/src/providers/llm.factory.ts.');
      llm = new StubLLMProvider();
      break;
    default:
      llm = new StubLLMProvider();
  ...
  app.post('/v1/tutor/stream', async (req, reply) => {
    ...
    const q: TutorQuery = parsed.data;
