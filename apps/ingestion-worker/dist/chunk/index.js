...
export function chunkDocument(doc, opts = DEFAULT_CHUNK_OPTIONS) {
    const chunks = [];
...
function chunkSection(sec, opts) {
...
function makeChunk(sec, sentences, tokens) {
    return {
        heading: sec.heading,
...
function hardSplit(sentence, maxTokens) {
...
function takeOverlap(sentences, totalTokens, overlapTokens) {
